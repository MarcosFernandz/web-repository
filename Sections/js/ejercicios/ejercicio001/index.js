...
console.log("me gusta mcuho la peli"+ movies[1].movie+"dirigida por" +movies[1].director[0]
)


//template literal ==== ECMA script 6
console.log(`NEW WAY === Me gusta mucho la peli ${movies[1].movie} dirigida por ${movies[1].director[0]}
`);
